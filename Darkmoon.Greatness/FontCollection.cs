...
public static class AlibabaFontSettings
{
    ...
    public static Uri Source { get; } = new("avares://Darkmoon.Greatness/Assets/Fonts/AliBaba", UriKind.Absolute);
}
...
public static class HarmonyOsFontSettings
{
    ...
    public static Uri Source { get; } = new("avares://Darkmoon.Greatness/Assets/Fonts/HarmonyOS Sans", UriKind.Absolute);
}
