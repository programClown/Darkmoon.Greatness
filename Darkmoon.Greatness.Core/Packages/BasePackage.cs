using Octokit;
using Darkmoon.Greatness.Core.Helper;
using Darkmoon.Greatness.Core.Helper.HardwareInfo;
using Darkmoon.Greatness.Core.Models;
using Darkmoon.Greatness.Core.Models.Database;
using Darkmoon.Greatness.Core.Models.FileInterfaces;
using Darkmoon.Greatness.Core.Models.Packages;
using Darkmoon.Greatness.Core.Models.Progress;
using Darkmoon.Greatness.Core.Processes;
using Darkmoon.Greatness.Core.Python;
using PackageType = Darkmoon.Greatness.Core.Models.PackageType;

namespace Darkmoon.Greatness.Core.Packages;
